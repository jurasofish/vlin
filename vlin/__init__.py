...
class Expr(spa.csr_matrix):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)


class Cons(spa.csr_matrix):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class Model:
    ...
    def __init__(self, max_vars: int = 5, max_constrs: int = 10):
        ...
        self.cons = Cons((max_constrs, self.max_vars), dtype=self.dtype)
